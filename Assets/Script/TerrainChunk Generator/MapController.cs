...
public class MapController : MonoBehaviour
{
    ...
    AnimationAndMovementController pm;
    ...
    void ChunkChecker()
    {
        ...
        if (pm.currentMovement.x > 0 && pm.currentMovement.y == 0)
        {
        ...
        else if (pm.currentMovement.x < 0 && pm.currentMovement.y == 0)
        {
        ...
        else if (pm.currentMovement.y > 0 && pm.currentMovement.x == 0)
        {
